...
CREATE TABLE "session_employees" (
    ...
    CONSTRAINT "session_employees_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "session_employees" ADD CONSTRAINT "session_employees_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "session_employees" ADD CONSTRAINT "session_employees_employee_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE CASCADE;
