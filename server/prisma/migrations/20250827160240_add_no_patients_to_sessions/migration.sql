...
INSERT INTO "new_sessions" ("created_at", "day", "end_time", "every_two_weeks", "id", "notes", "room_id", "schedule_id", "start_time", "updated_at") SELECT "created_at", "day", "end_time", "every_two_weeks", "id", "notes", "room_id", "schedule_id", "start_time", "updated_at" FROM "sessions";
DROP TABLE "sessions";
